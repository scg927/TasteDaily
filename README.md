...
> 每日推荐一道菜的中式美食 App，支持 Android / iOS / 鸿蒙三端。
...
| `app/` | Android 应用（日历主页、菜谱浏览、详情、沉浸式烹饪、视频播放） |
...
- **日历主页**：月历视图，点击任意日期查看当日推荐菜
- **菜谱浏览**：18 道菜平铺展示，点击进入详情
- **每日推荐**：确定性算法，同一日期全员看到同一道菜
- **沉浸式烹饪**：分步指引，含图片/视频
...
| 平台 | 下载 |
|------|------|
| Android APK | [v3.0.0 Release](https://github.com/scg927/TasteDaily/releases/tag/v3.0.0) |
| 源码 | [v3.0.0 Source](https://github.com/scg927/TasteDaily/releases/tag/v3.0.0) |
